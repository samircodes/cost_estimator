...
# (VM -> DS3, and moderate effort contingencies for CDC / delete handling /
# primary key). "Not sure" is only added here, not to the shared app_config
# tuples, so the New Source form is unaffected.
NOT_SURE = "Not sure"
...
def render_source_systems_page() -> None:
    ...
    with st.form("source_systems_request"):
        ...
        st.markdown('<div class="form-divider"></div>', unsafe_allow_html=True)
        render_field_intro(9, "VM type", "The virtual machine type this pipeline runs on. Choose 'Not sure' and we'll use a sensible default.")
        ...
        with col_g:
            render_field_intro(10, "Primary key available", "Whether this source has a unique identifier per record. Choose 'Not sure' if you don't know.")
        ...
        with col_h:
            render_field_intro(11, "Delete handling", "How deleted records should be handled. Choose 'Not sure' if you don't know.")
        ...
        with col_j:
            render_field_intro(13, "CDC method", "How changes will be tracked for this source. Choose 'Not sure' if you don't know.")
